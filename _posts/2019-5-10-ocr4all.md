...
**Please note that the following comments refer to the version of May 2019**; there is now (September 2019) a new version with substantial (?) changes, which may behave differently.
